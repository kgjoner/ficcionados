<template>
    <div class="ebook-lp">
        <div class="ebook-img">
            <iframe width="800" height="800" border="0" name="dummyframe" id="dummyframe" style="display:none"></iframe>
        ...
        <div v-if="!hasSubscribed" class="ebook-form">
            ...
            <p style="padding-left: 15px;"><strong>+ 30 Novas Writing Prompts</strong> para ajudar você nos dias mais difíceis!&nbsp;</p>
            <p>&nbsp;</p>
            <p>E aí, preparado?</p>
            ...
            <div id="mc_embed_signup">
                <form action="//ficcionados.us15.list-manage.com/subscribe/post?u=27613588b850606cebd9fa4cd&amp;id=c022e8edfb"
                    ...
                    <div id="mc_embed_signup_scroll">
                        ...
                        <div class="clear"><input type="submit" value="Quero Desbloquear a Escrita!" name="subscribe" id="mc-embedded-subscribe" 
                            @click.prevent="afterSubscription" class="button"></div>
                    </div>
                </form>
            </div>
            <h6 style="text-align: left; padding-left: 7px;"><i class="fa fa-lock" style="font-size:14px; color:#FFF;"></i> Respeitamos sua privacidade.</h6>
        </div>
        <div v-else class="ebook-form subscribed">
            <h2>Seu ebook está pronto...</h2>
            <p>Não se preocupe caso não possa baixá-lo agora, enviaremos também para o seu email.</p>
            <a href="https://gallery.mailchimp.com/27613588b850606cebd9fa4cd/files/1ae73482-973f-4e1a-b9c4-14d8e8d1d853/Desbloqueando_a_Escrita_Ficcionados.pdf"><i class="fa fa-download"></i>Baixar "Desbloqueando a Escrita"</a>
        </div>
    </div>
</template>
